      ...
      <div className="bg-slate-900 border border-slate-800 rounded-3xl w-full max-w-lg overflow-hidden shadow-2xl">
        ...
        <div className="flex items-center justify-between p-4 border-b border-slate-800">
          <div className="flex items-center gap-2 text-white">
            ...
            <div>
              <h3 className="font-semibold text-sm">SCRFD Face ID Baseline Calibration</h3>
        ...
        <div className="p-6 flex flex-col items-center">
          <div className="relative w-72 h-72 rounded-full overflow-hidden border-4 border-emerald-500/50 shadow-xl bg-slate-950 flex items-center justify-center">
            {cameraError ? (
              ...
              <>
                ...
                {/* Oval Guide Overlay */}
                <div className="absolute inset-4 rounded-full border-2 border-dashed border-emerald-400/60 pointer-events-none flex items-center justify-center">
                  <span className="text-[10px] bg-slate-900/80 text-emerald-300 px-2 py-0.5 rounded-full backdrop-blur-sm">
          ...
          <div className="mt-4 text-center space-y-1">
            <p className="text-xs text-slate-300 font-medium">
              {capturedPhoto
                ...
                ? `Face Detected (${detectedFace.confidence * 100}%). Sharpness: ${detectedFace.quality.sharpnessScore}%.`
          ...
          {capturedPhoto ? (
            <>
              <button
                ...
                className="flex items-center gap-1.5 px-4 py-2 rounded-xl text-xs font-medium bg-slate-800 hover:bg-slate-700 text-slate-200 transition"
              >
