    ...
    <div className="p-4 sm:p-6 lg:p-8 space-y-6 sm:space-y-8 max-w-7xl mx-auto w-full">
      ...
      <div>
        <h2 className="text-xl sm:text-2xl font-bold text-white tracking-tight flex items-center gap-2.5">
          <Cpu className="w-5 h-5 sm:w-6 sm:h-6 text-emerald-400 shrink-0" />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8">
        ...
        <div className="lg:col-span-7 space-y-4 sm:space-y-6">
          ...
          <div className="glass-panel p-4 sm:p-6 rounded-2xl border border-slate-800 space-y-3 sm:space-y-4">
          ...
          <div className="glass-panel p-4 sm:p-6 rounded-2xl border border-slate-800 space-y-3 sm:space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 sm:gap-3">
              <button
                ...
                className={`p-2.5 sm:p-3 rounded-xl border text-[11px] sm:text-xs font-semibold transition text-center ${
                  faceMatchMode === 'MATCH'
          ...
          <button
            ...
            disabled={testing}
            className="w-full py-3 sm:py-3.5 rounded-xl bg-emerald-600 hover:bg-emerald-500 disabled:opacity-50 text-white font-bold text-xs sm:text-sm shadow-xl shadow-emerald-600/20 transition flex items-center justify-center gap-2"
          >
            {testing ? (
              <>
        ...
        <div className="lg:col-span-5 space-y-6">
          <div className="glass-panel p-4 sm:p-6 rounded-2xl border border-slate-800 space-y-4 sm:space-y-6 lg:sticky lg:top-24">
            <h3 className="text-xs sm:text-sm font-semibold text-white flex items-center gap-2">
